...
import {
 ...
 RefreshIcon, UploadIcon, AlertTriangleIcon, FuelIcon,
...
export default function Dashboard() {
 ...
 <StatDot color="bg-blue-500" label={t('coverageGaps')} value={coverageGaps} to="/renewals?tab=insights" />
...
function quickActionItems(t) {
 ...
 { to: '/vehicles?import=1', icon: UploadIcon, label: t('vehicleImportBtn', { defaultValue: 'Import Excel' }), color: 'bg-amber-50 text-amber-700 border-amber-100' },
 { to: '/documents', icon: RefreshIcon, label: t('navDocuments', { defaultValue: 'Documents' }), color: 'bg-rose-50 text-rose-600 border-rose-100' },
 { to: '/renewals?tab=insights', icon: ShieldIcon, label: t('renewalsTabInsights'), color: 'bg-emerald-50 text-emerald-600 border-emerald-100' },
 ]
}
