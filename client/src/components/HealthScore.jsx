export default function HealthScore({ score = 0, size = 120, segments = [], compact = false }) {
 ...
 className={
 compact
 ? 'flex flex-wrap justify-center sm:justify-start gap-x-3 gap-y-1 mt-2 text-[11px]'
 : 'grid grid-cols-2 gap-x-4 gap-y-1 mt-3 text-xs'
 }
 >
 {segments.map((seg) => (
