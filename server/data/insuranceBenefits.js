...
export const POLICY_TYPES = {
  comprehensive: {
    ...
    coveredRisks: [
      ...
      { key: 'riot', label: 'Riot / Strike Damage', labelHi: 'दंगा/हड़ताल', icon: '', covered: true },
  ...
  third_party: {
    ...
    coveredRisks: [
      ...
      { key: 'riot', label: 'Riot / Strike Damage', icon: '', covered: false },
  ...
  own_damage: {
    ...
    coveredRisks: [
      ...
      { key: 'riot', label: 'Riot / Strike Damage', icon: '', covered: true },
